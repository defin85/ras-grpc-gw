...
const (
	ClientService_Register_FullMethodName     = "/access.service.ClientService/Register"
	ClientService_GetClients_FullMethodName   = "/access.service.ClientService/GetClients"
	ClientService_ResetClients_FullMethodName = "/access.service.ClientService/ResetClients"
)
...
func (c *clientServiceClient) ResetClients(ctx context.Context, in *ResetClientsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ClientService_ResetClients_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClientService_ResetClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClientService_ResetClients_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
